...
results = save_experiment_results(
    ...
    experiment_name='regularized_trainable_vgg16',
    experiment_info=experiment_info,
    model=model,
...
print("1. regularized_trainable_vgg16_training_history.png - Training plots")
print("2. regularized_trainable_vgg16_results.json - Detailed metrics")