...
L2_LAMBDA = 0.0005  # Increased L2 regularization
...
experiment_info = {
    ...
    'architecture': {
        'layers': ['EfficientNetB0', 'GAP', 'Dense(512)', 'Dropout(0.3)', 'Dense(3)'],  # Update architecture
        'regularization': 'L2 + Dropout',
        'unfrozen_layers': 20  # Change from 8 to match actual code
    },
    'data_augmentation': {
        'enabled': True,
        'rotation_range': 10,
...
results = save_experiment_results(
    ...
    experiment_name='regularized_efficientnet' ,
    experiment_info=experiment_info,
    model=model,
...
print("1. regularized_efficientnet_training_history.png - Training plots")
print("2. regularized_efficientnet_results.json - Detailed metrics")